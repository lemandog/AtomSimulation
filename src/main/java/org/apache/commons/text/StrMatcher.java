...
public abstract class StrMatcher {
    ...
    public int isMatch(final char[] buffer, final int pos) {
        return isMatch(buffer, pos, buffer.length);
    }
    ...
    static final class CharSetMatcher extends StrMatcher {
         ...
         */
        @Override
        public int isMatch(final char[] buffer, final int pos, final int bufferEnd) {
    ...
    static final class StringMatcher extends StrMatcher {
         ...
         */
        @Override
        public int isMatch(final char[] buffer, int pos, final int bufferEnd) {
